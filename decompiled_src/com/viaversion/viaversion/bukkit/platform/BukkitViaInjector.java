...
extends LegacyViaInjector {
    ...
    protected void blame(ChannelHandler bootstrapAcceptor) throws ReflectiveOperationException {
        ...
        if (classLoader.getClass().getName().equals("org.bukkit.plugin.java.PluginClassLoader")) {
            ...
            String string2 = bootstrapAcceptor.getClass().getName();
            throw new RuntimeException("Unable to inject, due to " + string2 + ", try without the plugin " + string + "?");
        }
        String string = bootstrapAcceptor.getClass().getName();
        throw new RuntimeException("Unable to find core component 'childHandler', please check your plugins. issue: " + string);
    }
