...
extends AbstractEntityDataTypes {
    ...
    public final EntityDataType itemType = this.add(7, Types1_20_5.ITEM);
    ...
    public EntityDataTypes1_20_5(ParticleType particleType, ArrayType<Particle> particlesType) {
        super(31);
