...
extends BaseConstructor {
    ...
    private List<NodeTuple> mergeNode(MappingNode node, boolean isPreffered, Map<Object, Integer> key2index, List<NodeTuple> values2, boolean forceStringKeys) {
            ...
            if (keyNode.getTag().equals(Tag.MERGE)) {
                ...
                switch (valueNode.getNodeId()) {
                    case mapping: {
                        ...
                        this.mergeNode(mn, false, key2index, values2, forceStringKeys);
                        continue block4;
                    }
                    case sequence: {
                        ...
                        for (Node subnode : vals) {
                            ...
                            this.mergeNode(mnode, false, key2index, values2, forceStringKeys);
                        }
                        continue block4;
                    }
                    default: {
