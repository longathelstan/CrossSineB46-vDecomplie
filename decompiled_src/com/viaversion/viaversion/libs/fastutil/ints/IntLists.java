...
public final class IntLists {
    ...
    Cloneable {
        ...
        @Override
        @Deprecated
        public void add(int index2, Integer k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public Integer set(int index2, Integer k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public void setElements(int index2, int[] a) {
            throw new UnsupportedOperationException();
        }
    ...
    implements IntList {
        ...
        @Override
        @Deprecated
        public final void add(int index2, int k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final boolean addAll(int index2, Collection<? extends Integer> c) {
            throw new UnsupportedOperationException();
        }

        @Override
        @Deprecated
        public final int removeInt(int index2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final void add(int index2, Integer k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final Integer remove(int index2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final Integer set(int index2, Integer k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final boolean addAll(int index2, IntCollection c) {
            throw new UnsupportedOperationException();
        }

        @Override
        @Deprecated
        public final boolean addAll(int index2, IntList c) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final int set(int index2, int k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final void addElements(int index2, int[] a, int offset, int length) {
            throw new UnsupportedOperationException();
        }

        @Override
        @Deprecated
        public final void setElements(int index2, int[] a, int offset, int length) {
            throw new UnsupportedOperationException();
        }
