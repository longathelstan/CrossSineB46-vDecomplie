...
public final class IntArrays {
    ...
    private static void selectionSort(int[] a, int from, int to, IntComparator comp) {
        for (int i = from; i < to - 1; ++i) {
            ...
            for (int j = i + 1; j < to; ++j) {
                if (comp.compare(a[j], a[m2]) >= 0) continue;
                m2 = j;
            }
            if (m2 == i) continue;
            int u = a[i];
    ...
    public static void quickSort(int[] x, int from, int to, IntComparator comp) {
        ...
        if (len > 128) {
            ...
            m2 = IntArrays.med3(x, m2 - s, m2, m2 + s, comp);
            n = IntArrays.med3(x, n - 2 * s, n - s, n, comp);
        }
        m2 = IntArrays.med3(x, l, m2, n, comp);
        int v = x[m2];
        int b = a = from;
        int d = c = to - 1;
        while (true) {
    ...
    public static void quickSort(int[] x, int from, int to) {
        ...
        if (len > 128) {
            ...
            m2 = IntArrays.med3(x, m2 - s, m2, m2 + s);
            n = IntArrays.med3(x, n - 2 * s, n - s, n);
        }
        m2 = IntArrays.med3(x, l, m2, n);
        int v = x[m2];
        int b = a = from;
        int d = c = to - 1;
        while (true) {
    ...
    public static void quickSortIndirect(int[] perm, int[] x, int from, int to) {
        ...
        if (len > 128) {
            ...
            m2 = IntArrays.med3Indirect(perm, x, m2 - s, m2, m2 + s);
            n = IntArrays.med3Indirect(perm, x, n - 2 * s, n - s, n);
        }
        m2 = IntArrays.med3Indirect(perm, x, l, m2, n);
        int v = x[perm[m2]];
        int b = a = from;
        int d = c = to - 1;
        while (true) {
    ...
    private static void selectionSort(int[] a, int[] b, int from, int to) {
        for (int i = from; i < to - 1; ++i) {
            int m2 = i;
            for (int j = i + 1; j < to; ++j) {
                int u = Integer.compare(a[j], a[m2]);
                if (u >= 0 && (u != 0 || b[j] >= b[m2])) continue;
                m2 = j;
            }
            if (m2 == i) continue;
            int t = a[i];
    ...
    public static void quickSort(int[] x, int[] y, int from, int to) {
        ...
        if (len > 128) {
            ...
            m2 = IntArrays.med3(x, y, m2 - s, m2, m2 + s);
            n = IntArrays.med3(x, y, n - 2 * s, n - s, n);
        }
        m2 = IntArrays.med3(x, y, l, m2, n);
        int v = x[m2];
        int w = y[m2];
        int b = a = from;
        int d = c = to - 1;
        ...
        for (int i = from; i < to - 1; ++i) {
            ...
            block1: for (int j = i + 1; j < to; ++j) {
                for (int p = firstLayer; p < layers; ++p) {
                    ...
                    if (a[p][j] > a[p][m2]) continue block1;
                }
            }
            if (m2 == i) continue;
            int p = layers;
    ...
    extends RecursiveAction {
        ...
        protected void compute() {
            ...
            m2 = IntArrays.med3(x, m2 - s, m2, m2 + s, this.comp);
            n = IntArrays.med3(x, n - 2 * s, n - s, n, this.comp);
            m2 = IntArrays.med3(x, l, m2, n, this.comp);
            int v = x[m2];
            int b = a = this.from;
            int d = c = this.to - 1;
            while (true) {
    ...
    extends RecursiveAction {
        ...
        protected void compute() {
            ...
            m2 = IntArrays.med3Indirect(this.perm, x, m2 - s, m2, m2 + s);
            n = IntArrays.med3Indirect(this.perm, x, n - 2 * s, n - s, n);
            m2 = IntArrays.med3Indirect(this.perm, x, l, m2, n);
            int v = x[this.perm[m2]];
            int b = a = this.from;
            int d = c = this.to - 1;
            while (true) {
                int comparison;
