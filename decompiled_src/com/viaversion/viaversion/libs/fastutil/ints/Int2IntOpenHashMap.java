...
Hash {
    ...
    public Int2IntOpenHashMap(Map<? extends Integer, ? extends Integer> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    public Int2IntOpenHashMap(Int2IntMap m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    implements ObjectIterator<Int2IntMap.Entry> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Int2IntMap.Entry> action, int index2) {
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index2) {
            action.accept(Int2IntOpenHashMap.this.value[index2]);
        }
    ...
    implements IntSpliterator {
        ...
        @Override
        final void acceptOnIndex(IntConsumer action, int index2) {
            action.accept(Int2IntOpenHashMap.this.key[index2]);
        }
