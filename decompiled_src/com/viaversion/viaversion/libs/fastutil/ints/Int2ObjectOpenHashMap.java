...
Hash {
    ...
    public Int2ObjectOpenHashMap(Map<? extends Integer, ? extends V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    public Int2ObjectOpenHashMap(Int2ObjectMap<V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Int2ObjectMap.Entry<V>> action, int index2) {
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index2) {
            action.accept(Int2ObjectOpenHashMap.this.value[index2]);
        }
    ...
    implements IntSpliterator {
        ...
        final void acceptOnIndex(IntConsumer action, int index2) {
            action.accept(Int2ObjectOpenHashMap.this.key[index2]);
        }
