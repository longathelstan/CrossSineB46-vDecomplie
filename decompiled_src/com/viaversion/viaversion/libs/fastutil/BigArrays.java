...
public class BigArrays {
    ...
    public static void quickSort(long from, long to, LongComparator comp, BigSwapper swapper) {
        ...
        if (len > 7L) {
            ...
            if (len > 40L) {
                ...
                m2 = BigArrays.med3(m2 - s, m2, m2 + s, comp);
                n = BigArrays.med3(n - 2L * s, n - s, n, comp);
            }
            m2 = BigArrays.med3(l, m2, n, comp);
        }
        long b = a = from;
        long d = c = to - 1L;
        while (true) {
            int comparison;
            if (b <= c && (comparison = comp.compare(b, m2)) <= 0) {
                if (comparison == 0) {
                    if (a == m2) {
                        m2 = b;
                    } else if (b == m2) {
    ...
    public static byte get(byte[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(byte[][] array, long index2, byte value) {
    ...
    public static void add(byte[][] array, long index2, byte incr) {
        byte[] byArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        byArray[n] = (byte)(byArray[n] + incr);
    }

    public static void mul(byte[][] array, long index2, byte factor) {
        byte[] byArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        byArray[n] = (byte)(byArray[n] * factor);
    }

    public static void incr(byte[][] array, long index2) {
        byte[] byArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        byArray[n] = (byte)(byArray[n] + 1);
    }

    public static void decr(byte[][] array, long index2) {
        byte[] byArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        byArray[n] = (byte)(byArray[n] - 1);
    }
    ...
    public static int get(int[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(int[][] array, long index2, int value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static int get(AtomicIntegerArray[] array, long index2) {
        return array[BigArrays.segment(index2)].get(BigArrays.displacement(index2));
    }

    public static void set(AtomicIntegerArray[] array, long index2, int value) {
        array[BigArrays.segment(index2)].set(BigArrays.displacement(index2), value);
    }

    public static int getAndSet(AtomicIntegerArray[] array, long index2, int value) {
        return array[BigArrays.segment(index2)].getAndSet(BigArrays.displacement(index2), value);
    }

    public static int getAndAdd(AtomicIntegerArray[] array, long index2, int value) {
        return array[BigArrays.segment(index2)].getAndAdd(BigArrays.displacement(index2), value);
    }

    public static int addAndGet(AtomicIntegerArray[] array, long index2, int value) {
        return array[BigArrays.segment(index2)].addAndGet(BigArrays.displacement(index2), value);
    }

    public static int getAndIncrement(AtomicIntegerArray[] array, long index2) {
        return array[BigArrays.segment(index2)].getAndDecrement(BigArrays.displacement(index2));
    }

    public static int incrementAndGet(AtomicIntegerArray[] array, long index2) {
        return array[BigArrays.segment(index2)].incrementAndGet(BigArrays.displacement(index2));
    }

    public static int getAndDecrement(AtomicIntegerArray[] array, long index2) {
        return array[BigArrays.segment(index2)].getAndDecrement(BigArrays.displacement(index2));
    }

    public static int decrementAndGet(AtomicIntegerArray[] array, long index2) {
        return array[BigArrays.segment(index2)].decrementAndGet(BigArrays.displacement(index2));
    }

    public static boolean compareAndSet(AtomicIntegerArray[] array, long index2, int expected, int value) {
        return array[BigArrays.segment(index2)].compareAndSet(BigArrays.displacement(index2), expected, value);
    }
    ...
    public static void add(int[][] array, long index2, int incr) {
        int[] nArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        nArray[n] = nArray[n] + incr;
    }

    public static void mul(int[][] array, long index2, int factor) {
        int[] nArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        nArray[n] = nArray[n] * factor;
    }

    public static void incr(int[][] array, long index2) {
        int[] nArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        nArray[n] = nArray[n] + 1;
    }

    public static void decr(int[][] array, long index2) {
        int[] nArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        nArray[n] = nArray[n] - 1;
    }
    ...
    public static long get(long[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(long[][] array, long index2, long value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static long get(AtomicLongArray[] array, long index2) {
        return array[BigArrays.segment(index2)].get(BigArrays.displacement(index2));
    }

    public static void set(AtomicLongArray[] array, long index2, long value) {
        array[BigArrays.segment(index2)].set(BigArrays.displacement(index2), value);
    }

    public static long getAndSet(AtomicLongArray[] array, long index2, long value) {
        return array[BigArrays.segment(index2)].getAndSet(BigArrays.displacement(index2), value);
    }

    public static long getAndAdd(AtomicLongArray[] array, long index2, long value) {
        return array[BigArrays.segment(index2)].getAndAdd(BigArrays.displacement(index2), value);
    }

    public static long addAndGet(AtomicLongArray[] array, long index2, long value) {
        return array[BigArrays.segment(index2)].addAndGet(BigArrays.displacement(index2), value);
    }

    public static long getAndIncrement(AtomicLongArray[] array, long index2) {
        return array[BigArrays.segment(index2)].getAndDecrement(BigArrays.displacement(index2));
    }

    public static long incrementAndGet(AtomicLongArray[] array, long index2) {
        return array[BigArrays.segment(index2)].incrementAndGet(BigArrays.displacement(index2));
    }

    public static long getAndDecrement(AtomicLongArray[] array, long index2) {
        return array[BigArrays.segment(index2)].getAndDecrement(BigArrays.displacement(index2));
    }

    public static long decrementAndGet(AtomicLongArray[] array, long index2) {
        return array[BigArrays.segment(index2)].decrementAndGet(BigArrays.displacement(index2));
    }

    public static boolean compareAndSet(AtomicLongArray[] array, long index2, long expected, long value) {
        return array[BigArrays.segment(index2)].compareAndSet(BigArrays.displacement(index2), expected, value);
    }
    ...
    public static void add(long[][] array, long index2, long incr) {
        long[] lArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        lArray[n] = lArray[n] + incr;
    }

    public static void mul(long[][] array, long index2, long factor) {
        long[] lArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        lArray[n] = lArray[n] * factor;
    }

    public static void incr(long[][] array, long index2) {
        long[] lArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        lArray[n] = lArray[n] + 1L;
    }

    public static void decr(long[][] array, long index2) {
        long[] lArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        lArray[n] = lArray[n] - 1L;
    }
    ...
    public static double get(double[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(double[][] array, long index2, double value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static void add(double[][] array, long index2, double incr) {
        double[] dArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        dArray[n] = dArray[n] + incr;
    }

    public static void mul(double[][] array, long index2, double factor) {
        double[] dArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        dArray[n] = dArray[n] * factor;
    }

    public static void incr(double[][] array, long index2) {
        double[] dArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        dArray[n] = dArray[n] + 1.0;
    }

    public static void decr(double[][] array, long index2) {
        double[] dArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        dArray[n] = dArray[n] - 1.0;
    }
    ...
    public static boolean get(boolean[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(boolean[][] array, long index2, boolean value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static char get(char[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(char[][] array, long index2, char value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static void add(char[][] array, long index2, char incr) {
        char[] cArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        cArray[n] = (char)(cArray[n] + incr);
    }

    public static void mul(char[][] array, long index2, char factor) {
        char[] cArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        cArray[n] = (char)(cArray[n] * factor);
    }

    public static void incr(char[][] array, long index2) {
        char[] cArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        cArray[n] = (char)(cArray[n] + '\u0001');
    }

    public static void decr(char[][] array, long index2) {
        char[] cArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        cArray[n] = (char)(cArray[n] - '\u0001');
    }
    ...
    public static float get(float[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static void set(float[][] array, long index2, float value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
    ...
    public static void add(float[][] array, long index2, float incr) {
        float[] fArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        fArray[n] = fArray[n] + incr;
    }

    public static void mul(float[][] array, long index2, float factor) {
        float[] fArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        fArray[n] = fArray[n] * factor;
    }

    public static void incr(float[][] array, long index2) {
        float[] fArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        fArray[n] = fArray[n] + 1.0f;
    }

    public static void decr(float[][] array, long index2) {
        float[] fArray = array[BigArrays.segment(index2)];
        int n = BigArrays.displacement(index2);
        fArray[n] = fArray[n] - 1.0f;
    }
    ...
    public static <K> K get(K[][] array, long index2) {
        return array[BigArrays.segment(index2)][BigArrays.displacement(index2)];
    }

    public static <K> void set(K[][] array, long index2, K value) {
        array[BigArrays.segment((long)index2)][BigArrays.displacement((long)index2)] = value;
    }
