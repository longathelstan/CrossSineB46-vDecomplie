...
Hash {
    ...
    public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Reference2ObjectMap.Entry<K, V>> action, int index2) {
            this.entry = new MapEntry(index2);
    ...
    implements ObjectSpliterator<V> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super V> action, int index2) {
            action.accept(Reference2ObjectOpenHashMap.this.value[index2]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super K> action, int index2) {
            action.accept(Reference2ObjectOpenHashMap.this.key[index2]);
        }
    ...
    implements ObjectSpliterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Reference2ObjectMap.Entry<K, V>> action, int index2) {
            action.accept(new MapEntry(index2));
        }
