...
public final class ObjectLists {
    ...
    Cloneable {
        ...
        @Override
        public void setElements(int index2, K[] a) {
            throw new UnsupportedOperationException();
        }
    ...
    implements ObjectList<K> {
        ...
        @Override
        @Deprecated
        public final void add(int index2, K k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final boolean addAll(int index2, Collection<? extends K> c) {
            throw new UnsupportedOperationException();
        }

        @Override
        @Deprecated
        public final K remove(int index2) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final K set(int index2, K k) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public final void addElements(int index2, K[] a, int offset, int length) {
            throw new UnsupportedOperationException();
        }

        @Override
        @Deprecated
        public final void setElements(int index2, K[] a, int offset, int length) {
            throw new UnsupportedOperationException();
        }
