...
public final class ObjectArrays {
    ...
    public static <K> void quickSort(K[] x, int from, int to, Comparator<K> comp) {
        ...
        m2 = ObjectArrays.med3(x, l, m2, n, comp);
        K v = x[m2];
        int b = a = from;
        int d = c = to - 1;
        while (true) {
    ...
    private static <K> void selectionSort(K[] a, int from, int to) {
        for (int i = from; i < to - 1; ++i) {
            int m2 = i;
            for (int j = i + 1; j < to; ++j) {
                if (((Comparable)a[j]).compareTo(a[m2]) >= 0) continue;
                m2 = j;
            }
            if (m2 == i) continue;
            K u = a[i];
    ...
    public static <K> void quickSortIndirect(int[] perm, K[] x, int from, int to) {
        ...
        if (len > 128) {
            ...
            m2 = ObjectArrays.med3Indirect(perm, x, m2 - s, m2, m2 + s);
            n = ObjectArrays.med3Indirect(perm, x, n - 2 * s, n - s, n);
        }
        m2 = ObjectArrays.med3Indirect(perm, x, l, m2, n);
        K v = x[perm[m2]];
        int b = a = from;
        int d = c = to - 1;
        while (true) {
    ...
    private static <K> void selectionSort(K[] a, K[] b, int from, int to) {
        for (int i = from; i < to - 1; ++i) {
            int m2 = i;
            for (int j = i + 1; j < to; ++j) {
                int u = ((Comparable)a[j]).compareTo(a[m2]);
                if (u >= 0 && (u != 0 || ((Comparable)b[j]).compareTo(b[m2]) >= 0)) continue;
                m2 = j;
            }
            if (m2 == i) continue;
            K t = a[i];
    ...
    public static <K> void quickSort(K[] x, K[] y, int from, int to) {
        ...
        if (len > 128) {
            ...
            m2 = ObjectArrays.med3(x, y, m2 - s, m2, m2 + s);
            n = ObjectArrays.med3(x, y, n - 2 * s, n - s, n);
        }
        m2 = ObjectArrays.med3(x, y, l, m2, n);
        K v = x[m2];
        K w = y[m2];
        int b = a = from;
        int d = c = to - 1;
    ...
    extends RecursiveAction {
        ...
        protected void compute() {
            ...
            m2 = ObjectArrays.med3(x, m2 - s, m2, m2 + s, this.comp);
            n = ObjectArrays.med3(x, n - 2 * s, n - s, n, this.comp);
            m2 = ObjectArrays.med3(x, l, m2, n, this.comp);
            Object v = x[m2];
            int b = a = this.from;
            int d = c = this.to - 1;
            while (true) {
    ...
    extends RecursiveAction {
        ...
        protected void compute() {
            ...
            m2 = ObjectArrays.med3Indirect(this.perm, x, m2 - s, m2, m2 + s);
            n = ObjectArrays.med3Indirect(this.perm, x, n - 2 * s, n - s, n);
            m2 = ObjectArrays.med3Indirect(this.perm, x, l, m2, n);
            Object v = x[this.perm[m2]];
            int b = a = this.from;
            int d = c = this.to - 1;
            while (true) {
                int comparison;
