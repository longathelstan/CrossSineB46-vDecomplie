...
Hash {
    ...
    public Object2IntOpenHashMap(Map<? extends K, ? extends Integer> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    public Object2IntOpenHashMap(Object2IntMap<K> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    implements ObjectIterator<Object2IntMap.Entry<K>> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Object2IntMap.Entry<K>> action, int index2) {
    ...
    implements IntSpliterator {
        ...
        @Override
        final void acceptOnIndex(IntConsumer action, int index2) {
            action.accept(Object2IntOpenHashMap.this.value[index2]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index2) {
            action.accept(Object2IntOpenHashMap.this.key[index2]);
        }
