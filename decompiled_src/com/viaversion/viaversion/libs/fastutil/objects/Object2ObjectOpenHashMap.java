...
Hash {
    ...
    public Object2ObjectOpenHashMap(Map<? extends K, ? extends V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    public Object2ObjectOpenHashMap(Object2ObjectMap<K, V> m2, float f) {
        this(m2.size(), f);
        this.putAll(m2);
    }
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>> {
        ...
        @Override
        final void acceptOnIndex(Consumer<? super Object2ObjectMap.Entry<K, V>> action, int index2) {
    ...
    implements ObjectSpliterator<V> {
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index2) {
            action.accept(Object2ObjectOpenHashMap.this.value[index2]);
        }
    ...
    implements ObjectSpliterator<K> {
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index2) {
            action.accept(Object2ObjectOpenHashMap.this.key[index2]);
        }
