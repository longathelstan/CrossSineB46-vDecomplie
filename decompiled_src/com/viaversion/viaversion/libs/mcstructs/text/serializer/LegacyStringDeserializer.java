...
public class LegacyStringDeserializer {
    ...
    public static ATextComponent parse(String s, char colorChar, Function<Character, TextFormatting> formattingResolver) {
        return LegacyStringDeserializer.parse(s, colorChar, Style::new, formattingResolver);
    }

    public static ATextComponent parse(String s, char colorChar, Supplier<Style> styleSupplier, Function<Character, TextFormatting> formattingResolver) {
