...
extends MappingDataBase {
    final Map<String, int[]> blockTags = new HashMap<String, int[]>();
    final Map<String, int[]> itemTags = new HashMap<String, int[]>();
    final Map<String, int[]> fluidTags = new HashMap<String, int[]>();
    final BiMap<Short, String> oldEnchantmentsIds = HashBiMap.create();
    final Map<String, String> translateMapping = new HashMap<String, String>();
    final Map<String, String> mojangTranslation = new HashMap<String, String>();
    final BiMap<String, String> channelMappings = HashBiMap.create();
        ...
        if ((object = MappingDataLoader.INSTANCE.loadFromDataDir("channelmappings-1.13.json")) != null) {
            for (Map.Entry<String, JsonElement> entry : object.entrySet()) {
                ...
                if (!Key.isValid(newChannel)) {
                    String string = newChannel;
                    this.getLogger().warning("Channel '" + string + "' is not a valid 1.13 plugin channel, please check your configuration!");
                    continue;
                }
    ...
    void loadTags(Map<String, int[]> output, CompoundTag newTags) {
    ...
    void loadEnchantments(Map<Short, String> output, CompoundTag enchantments) {
