...
@Plugin(id="viaversion", name="ViaVersion", version="5.0.4-SNAPSHOT", authors={"_MylesC", "creeper123123321", "Gerrygames", "kennytv", "Matsv", "EnZaXD", "RK_01"}, description="Allows the connection of newer clients to older server versions for Minecraft servers.", url="https://viaversion.com")
...
implements ViaServerProxyPlatform<Player> {
    ...
    public PlatformTask runSync(Runnable runnable, long delay2) {
        return new VelocityViaTask(PROXY.getScheduler().buildTask((Object)this, runnable).delay(delay2 * 50L, TimeUnit.MILLISECONDS).schedule());
    }
