...
implements UnsupportedSoftware {
    ...
    final List<UnsupportedMethods> methods;
    final String reason;
    ...
    public UnsupportedServerSoftware(String name, List<String> classNames, List<UnsupportedMethods> methods, String reason) {
        ...
        Preconditions.checkArgument((!classNames.isEmpty() || !methods.isEmpty() ? 1 : 0) != 0);
        this.name = name;
    ...
    public static final class Builder {
        ...
        final List<UnsupportedMethods> methods = new ArrayList<UnsupportedMethods>();
        String name;
        String reason;
