...
public final class ItemUtils {
    ...
    public static final int getItemDurability(@Nullable ItemStack stack) {
        ...
        return itemStack == null ? 0 : itemStack.func_77958_k() - stack.func_77952_i();
    }
    ...
    public static /* synthetic */ double getWeaponEnchantFactor$default(ItemUtils itemUtils, ItemStack itemStack, float f, EnumNBTPriorityType enumNBTPriorityType, int n, Object object) {
        if ((n & 2) != 0) {
            f = 0.0f;
        }
        if ((n & 4) != 0) {
        ...
        return itemUtils.getWeaponEnchantFactor(itemStack, f, enumNBTPriorityType);
    }
    ...
    public static /* synthetic */ int compareArmor$default(ItemUtils itemUtils, ArmorPiece armorPiece, ArmorPiece armorPiece2, float f, EnumNBTPriorityType enumNBTPriorityType, int n, Object object) {
        if ((n & 4) != 0) {
            f = 0.0f;
        }
        if ((n & 8) != 0) {
        ...
        return itemUtils.compareArmor(armorPiece, armorPiece2, f, enumNBTPriorityType);
    }
    ...
    @Metadata(mv={1, 6, 0}, k=1, xi=48, d1={"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006\u00a8\u0006\u0007"}, d2={"Lnet/ccbluex/liquidbounce/utils/item/ItemUtils$EnumNBTPriorityType;", "", "(Ljava/lang/String;I)V", "HAS_NAME", "HAS_LORE", "HAS_DISPLAY_TAG", "NONE", "CrossSine"})
