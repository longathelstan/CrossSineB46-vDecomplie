...
extends MinecraftInstance {
    ...
    public final void draw() {
        ...
        if (!((Collection)CrossSine.INSTANCE.getNotification().getList()).isEmpty()) {
            ...
            Iterator<NotificationUtil> iterator2 = CrossSine.INSTANCE.getNotification().getList().iterator();
            Intrinsics.checkNotNullExpressionValue(iterator2, "CrossSine.notification.list.iterator()");
