...
public final class ModuleTriggerCommand
extends Command {
    @NotNull
    ...
    public ModuleTriggerCommand() {
        ...
        void $this$map$iv;
        Object[] objectArray = new String[]{"trigger"};
        super("moduletrigger", (String[])objectArray);
        objectArray = EnumTriggerType.values();
        ModuleTriggerCommand moduleTriggerCommand = this;
        ...
        moduleTriggerCommand.modes = stringArray;
    }
    ...
    public void execute(@NotNull String[] args2) {
        ...
        if (args2.length > 2) {
            ...
            try {
                ...
                enumTriggerType = EnumTriggerType.valueOf(string);
            }
            catch (IllegalArgumentException illegalArgumentException) {
                module = module3;
                enumTriggerType = EnumTriggerType.TOGGLE;
            }
            module.setTriggerType(enumTriggerType);
            this.playEdit();
            this.alert("Set module \u00a7l" + module2.getName() + "\u00a7r trigger type to \u00a7l" + (Object)((Object)module2.getTriggerType()) + "\u00a7r.");
            return;
        }
