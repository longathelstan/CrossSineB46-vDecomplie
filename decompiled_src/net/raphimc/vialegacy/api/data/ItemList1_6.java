...
public class ItemList1_6 {
    ...
    public static final class Item1_6 {
        ...
        public Item1_6(int itemId, String name, int maxDamage, boolean hasSubTypes) {
            this.itemId = itemId;
            this.name = name;
        ...
        public boolean equals(Object object) {
            ...
            if (!(object instanceof Item1_6)) {
                return false;
            }
            Item1_6 item1_6 = (Item1_6)object;
            return this.itemId == item1_6.itemId && Objects.equals(this.name, item1_6.name) && this.maxDamage == item1_6.maxDamage && this.hasSubTypes == item1_6.hasSubTypes;
        }
