...
public enum ClientboundPacketsa1_2_2 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsa1_2_2[] REGISTRY;
    ...
    private ClientboundPacketsa1_2_2(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsa1_2_2[256];
        ClientboundPacketsa1_2_2[] clientboundPacketsa1_2_2Array = ClientboundPacketsa1_2_2.values();
        int n = clientboundPacketsa1_2_2Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsa1_2_2 packet;
            ClientboundPacketsa1_2_2.REGISTRY[packet.id] = packet = clientboundPacketsa1_2_2Array[i];
        }
    }
}
