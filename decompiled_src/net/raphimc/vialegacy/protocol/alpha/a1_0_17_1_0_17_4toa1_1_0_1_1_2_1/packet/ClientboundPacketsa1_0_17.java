...
public enum ClientboundPacketsa1_0_17 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsa1_0_17[] REGISTRY;
    ...
    private ClientboundPacketsa1_0_17(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsa1_0_17[256];
        ClientboundPacketsa1_0_17[] clientboundPacketsa1_0_17Array = ClientboundPacketsa1_0_17.values();
        int n = clientboundPacketsa1_0_17Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsa1_0_17 packet;
            ClientboundPacketsa1_0_17.REGISTRY[packet.id] = packet = clientboundPacketsa1_0_17Array[i];
        }
    }
}
