...
public enum ServerboundPacketsa1_0_17 implements ServerboundPacketType,
PreNettyPacketType
{
    ...
    private static final ServerboundPacketsa1_0_17[] REGISTRY;
    ...
    private ServerboundPacketsa1_0_17(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPacketsa1_0_17[256];
        ServerboundPacketsa1_0_17[] serverboundPacketsa1_0_17Array = ServerboundPacketsa1_0_17.values();
        int n = serverboundPacketsa1_0_17Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPacketsa1_0_17 packet;
            ServerboundPacketsa1_0_17.REGISTRY[packet.id] = packet = serverboundPacketsa1_0_17Array[i];
        }
    }
}
