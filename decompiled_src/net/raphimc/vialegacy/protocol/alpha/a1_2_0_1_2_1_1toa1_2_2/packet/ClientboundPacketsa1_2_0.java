...
public enum ClientboundPacketsa1_2_0 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsa1_2_0[] REGISTRY;
    ...
    private ClientboundPacketsa1_2_0(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsa1_2_0[256];
        ClientboundPacketsa1_2_0[] clientboundPacketsa1_2_0Array = ClientboundPacketsa1_2_0.values();
        int n = clientboundPacketsa1_2_0Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsa1_2_0 packet;
            ClientboundPacketsa1_2_0.REGISTRY[packet.id] = packet = clientboundPacketsa1_2_0Array[i];
        }
    }
}
