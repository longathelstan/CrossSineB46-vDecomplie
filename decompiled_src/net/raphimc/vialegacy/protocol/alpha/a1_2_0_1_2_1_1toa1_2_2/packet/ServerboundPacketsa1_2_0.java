...
public enum ServerboundPacketsa1_2_0 implements ServerboundPacketType,
PreNettyPacketType
{
    ...
    private static final ServerboundPacketsa1_2_0[] REGISTRY;
    ...
    private ServerboundPacketsa1_2_0(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPacketsa1_2_0[256];
        ServerboundPacketsa1_2_0[] serverboundPacketsa1_2_0Array = ServerboundPacketsa1_2_0.values();
        int n = serverboundPacketsa1_2_0Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPacketsa1_2_0 packet;
            ServerboundPacketsa1_2_0.REGISTRY[packet.id] = packet = serverboundPacketsa1_2_0Array[i];
        }
    }
}
