...
public enum ClientboundPacketsa1_0_15 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsa1_0_15[] REGISTRY;
    ...
    private ClientboundPacketsa1_0_15(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsa1_0_15[256];
        ClientboundPacketsa1_0_15[] clientboundPacketsa1_0_15Array = ClientboundPacketsa1_0_15.values();
        int n = clientboundPacketsa1_0_15Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsa1_0_15 packet;
            ClientboundPacketsa1_0_15.REGISTRY[packet.id] = packet = clientboundPacketsa1_0_15Array[i];
        }
    }
}
