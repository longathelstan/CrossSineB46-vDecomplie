...
public class AlphaItems {
    ...
    private static final Int2ObjectMap<Consumer<Item>> INTERACT_ACTION = new Int2ObjectOpenHashMap<Consumer<Item>>(14, 0.99f);
    private static final Int2ObjectMap<BiConsumer<Item, IntObjectPair<IdAndData>>> PLACE_ACTION = new Int2ObjectOpenHashMap<BiConsumer<Item, IntObjectPair<IdAndData>>>(15, 0.99f);
    ...
    public static void doPlace(Item item, short direction, IdAndData placedAgainst) {
        ((BiConsumer)PLACE_ACTION.get(item.identifier())).accept(item, new IntObjectImmutablePair<IdAndData>(direction, placedAgainst));
    }
    ...
    static {
        ...
        PLACE_ACTION.defaultReturnValue((i, d) -> i.identifier());
        PLACE_ACTION.put(259, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            i.setData((short)(i.data() + 1));
            if (i.data() > 64) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(290, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
        ...
        PLACE_ACTION.put(291, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
                i.setData((short)(i.data() + 1));
                if (i.data() > 64) {
                    i.setAmount(i.amount() - 1);
        ...
        PLACE_ACTION.put(292, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
                i.setData((short)(i.data() + 1));
                if (i.data() > 128) {
                    i.setAmount(i.amount() - 1);
        ...
        PLACE_ACTION.put(293, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
                i.setData((short)(i.data() + 1));
                if (i.data() > 256) {
                    i.setAmount(i.amount() - 1);
        ...
        PLACE_ACTION.put(294, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
                i.setData((short)(i.data() + 1));
                if (i.data() > 64) {
                    i.setAmount(i.amount() - 1);
        ...
        PLACE_ACTION.put(295, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (d.keyInt() == 1 && ((IdAndData)d.value()).getId() == BlockList1_6.tilledField.blockId()) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(321, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (d.keyInt() != 0 && d.keyInt() != 1) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(324, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (d.keyInt() == 1) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(328, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(330, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (d.keyInt() == 1) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(342, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(343, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(2256, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.jukebox.blockId() && ((IdAndData)d.value()).getData() == 0) {
                i.setAmount(i.amount() - 1);
            }
        }));
        PLACE_ACTION.put(2257, (BiConsumer<Item, IntObjectPair<IdAndData>>)((BiConsumer<Item, IntObjectPair>)(i, d) -> {
            if (((IdAndData)d.value()).getId() == BlockList1_6.jukebox.blockId() && ((IdAndData)d.value()).getData() == 0) {
                i.setAmount(i.amount() - 1);
            }
        }));
