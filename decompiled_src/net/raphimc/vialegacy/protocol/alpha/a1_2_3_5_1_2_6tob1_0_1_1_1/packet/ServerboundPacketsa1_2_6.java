...
public enum ServerboundPacketsa1_2_6 implements ServerboundPacketType,
PreNettyPacketType
{
    ...
    private static final ServerboundPacketsa1_2_6[] REGISTRY;
    ...
    private ServerboundPacketsa1_2_6(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPacketsa1_2_6[256];
        ServerboundPacketsa1_2_6[] serverboundPacketsa1_2_6Array = ServerboundPacketsa1_2_6.values();
        int n = serverboundPacketsa1_2_6Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPacketsa1_2_6 packet;
            ServerboundPacketsa1_2_6.REGISTRY[packet.id] = packet = serverboundPacketsa1_2_6Array[i];
        }
    }
}
