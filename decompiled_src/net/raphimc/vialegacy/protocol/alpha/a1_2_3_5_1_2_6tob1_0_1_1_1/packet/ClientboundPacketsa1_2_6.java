...
public enum ClientboundPacketsa1_2_6 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsa1_2_6[] REGISTRY;
    ...
    private ClientboundPacketsa1_2_6(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsa1_2_6[256];
        ClientboundPacketsa1_2_6[] clientboundPacketsa1_2_6Array = ClientboundPacketsa1_2_6.values();
        int n = clientboundPacketsa1_2_6Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsa1_2_6 packet;
            ClientboundPacketsa1_2_6.REGISTRY[packet.id] = packet = clientboundPacketsa1_2_6Array[i];
        }
    }
}
