...
public enum ClientboundPacketsb1_4 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsb1_4[] REGISTRY;
    ...
    private ClientboundPacketsb1_4(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsb1_4[256];
        ClientboundPacketsb1_4[] clientboundPacketsb1_4Array = ClientboundPacketsb1_4.values();
        int n = clientboundPacketsb1_4Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsb1_4 packet;
            ClientboundPacketsb1_4.REGISTRY[packet.id] = packet = clientboundPacketsb1_4Array[i];
        }
    }
}
