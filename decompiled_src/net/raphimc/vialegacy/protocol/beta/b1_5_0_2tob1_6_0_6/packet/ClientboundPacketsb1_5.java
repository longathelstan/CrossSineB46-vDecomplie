...
public enum ClientboundPacketsb1_5 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsb1_5[] REGISTRY;
    ...
    private ClientboundPacketsb1_5(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsb1_5[256];
        ClientboundPacketsb1_5[] clientboundPacketsb1_5Array = ClientboundPacketsb1_5.values();
        int n = clientboundPacketsb1_5Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsb1_5 packet;
            ClientboundPacketsb1_5.REGISTRY[packet.id] = packet = clientboundPacketsb1_5Array[i];
        }
    }
}
