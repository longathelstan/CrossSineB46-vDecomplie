...
public enum ServerboundPacketsb1_2 implements ServerboundPacketType,
PreNettyPacketType
{
    ...
    private static final ServerboundPacketsb1_2[] REGISTRY;
    ...
    private ServerboundPacketsb1_2(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPacketsb1_2[256];
        ServerboundPacketsb1_2[] serverboundPacketsb1_2Array = ServerboundPacketsb1_2.values();
        int n = serverboundPacketsb1_2Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPacketsb1_2 packet;
            ServerboundPacketsb1_2.REGISTRY[packet.id] = packet = serverboundPacketsb1_2Array[i];
        }
    }
}
