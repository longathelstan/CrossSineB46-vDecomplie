...
public enum ClientboundPacketsb1_2 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsb1_2[] REGISTRY;
    ...
    private ClientboundPacketsb1_2(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsb1_2[256];
        ClientboundPacketsb1_2[] clientboundPacketsb1_2Array = ClientboundPacketsb1_2.values();
        int n = clientboundPacketsb1_2Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsb1_2 packet;
            ClientboundPacketsb1_2.REGISTRY[packet.id] = packet = clientboundPacketsb1_2Array[i];
        }
    }
}
