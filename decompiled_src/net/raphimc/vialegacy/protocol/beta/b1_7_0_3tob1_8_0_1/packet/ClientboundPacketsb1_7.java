...
public enum ClientboundPacketsb1_7 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsb1_7[] REGISTRY;
    ...
    private ClientboundPacketsb1_7(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsb1_7[256];
        ClientboundPacketsb1_7[] clientboundPacketsb1_7Array = ClientboundPacketsb1_7.values();
        int n = clientboundPacketsb1_7Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsb1_7 packet;
            ClientboundPacketsb1_7.REGISTRY[packet.id] = packet = clientboundPacketsb1_7Array[i];
        }
    }
}
