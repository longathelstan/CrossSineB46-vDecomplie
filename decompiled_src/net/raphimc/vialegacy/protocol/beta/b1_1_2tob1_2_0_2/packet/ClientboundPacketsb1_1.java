...
public enum ClientboundPacketsb1_1 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPacketsb1_1[] REGISTRY;
    ...
    private ClientboundPacketsb1_1(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPacketsb1_1[256];
        ClientboundPacketsb1_1[] clientboundPacketsb1_1Array = ClientboundPacketsb1_1.values();
        int n = clientboundPacketsb1_1Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPacketsb1_1 packet;
            ClientboundPacketsb1_1.REGISTRY[packet.id] = packet = clientboundPacketsb1_1Array[i];
        }
    }
}
