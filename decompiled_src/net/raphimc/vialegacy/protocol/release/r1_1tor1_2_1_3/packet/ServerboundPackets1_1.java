...
PreNettyPacketType
{
    ...
    private static final ServerboundPackets1_1[] REGISTRY;
    ...
    private ServerboundPackets1_1(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPackets1_1[256];
        ServerboundPackets1_1[] serverboundPackets1_1Array = ServerboundPackets1_1.values();
        int n = serverboundPackets1_1Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPackets1_1 packet;
            ServerboundPackets1_1.REGISTRY[packet.id] = packet = serverboundPackets1_1Array[i];
        }
    }
}
