...
public enum ClientboundPackets1_1 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPackets1_1[] REGISTRY;
    ...
    private ClientboundPackets1_1(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPackets1_1[256];
        ClientboundPackets1_1[] clientboundPackets1_1Array = ClientboundPackets1_1.values();
        int n = clientboundPackets1_1Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPackets1_1 packet;
            ClientboundPackets1_1.REGISTRY[packet.id] = packet = clientboundPackets1_1Array[i];
        }
    }
}
