...
public enum ClientboundPackets1_0_0 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPackets1_0_0[] REGISTRY;
    ...
    private ClientboundPackets1_0_0(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPackets1_0_0[256];
        ClientboundPackets1_0_0[] clientboundPackets1_0_0Array = ClientboundPackets1_0_0.values();
        int n = clientboundPackets1_0_0Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPackets1_0_0 packet;
            ClientboundPackets1_0_0.REGISTRY[packet.id] = packet = clientboundPackets1_0_0Array[i];
        }
    }
}
