...
public enum ClientboundPackets1_4_4 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPackets1_4_4[] REGISTRY;
    ...
    private ClientboundPackets1_4_4(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPackets1_4_4[256];
        ClientboundPackets1_4_4[] clientboundPackets1_4_4Array = ClientboundPackets1_4_4.values();
        int n = clientboundPackets1_4_4Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPackets1_4_4 packet;
            ClientboundPackets1_4_4.REGISTRY[packet.id] = packet = clientboundPackets1_4_4Array[i];
        }
    }
}
