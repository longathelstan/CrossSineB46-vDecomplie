...
public enum ServerboundPackets1_2_1 implements ServerboundPacketType,
PreNettyPacketType
{
    ...
    private static final ServerboundPackets1_2_1[] REGISTRY;
    ...
    private ServerboundPackets1_2_1(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPackets1_2_1[256];
        ServerboundPackets1_2_1[] serverboundPackets1_2_1Array = ServerboundPackets1_2_1.values();
        int n = serverboundPackets1_2_1Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPackets1_2_1 packet;
            ServerboundPackets1_2_1.REGISTRY[packet.id] = packet = serverboundPackets1_2_1Array[i];
        }
    }
}
