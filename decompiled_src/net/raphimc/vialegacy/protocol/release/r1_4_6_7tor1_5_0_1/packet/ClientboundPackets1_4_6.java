...
public enum ClientboundPackets1_4_6 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPackets1_4_6[] REGISTRY;
    ...
    private ClientboundPackets1_4_6(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPackets1_4_6[256];
        ClientboundPackets1_4_6[] clientboundPackets1_4_6Array = ClientboundPackets1_4_6.values();
        int n = clientboundPackets1_4_6Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPackets1_4_6 packet;
            ClientboundPackets1_4_6.REGISTRY[packet.id] = packet = clientboundPackets1_4_6Array[i];
        }
    }
}
