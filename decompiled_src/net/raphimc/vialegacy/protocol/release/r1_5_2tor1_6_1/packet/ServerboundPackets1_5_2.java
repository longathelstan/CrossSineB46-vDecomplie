...
PreNettyPacketType
{
    ...
    private static final ServerboundPackets1_5_2[] REGISTRY;
    ...
    private ServerboundPackets1_5_2(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ServerboundPackets1_5_2[256];
        ServerboundPackets1_5_2[] serverboundPackets1_5_2Array = ServerboundPackets1_5_2.values();
        int n = serverboundPackets1_5_2Array.length;
        for (int i = 0; i < n; ++i) {
            ServerboundPackets1_5_2 packet;
            ServerboundPackets1_5_2.REGISTRY[packet.id] = packet = serverboundPackets1_5_2Array[i];
        }
    }
}
