...
public enum ClientboundPackets1_4_2 implements ClientboundPacketType,
PreNettyPacketType
{
    ...
    private static final ClientboundPackets1_4_2[] REGISTRY;
    ...
    private ClientboundPackets1_4_2(int id, BiConsumer<UserConnection, ByteBuf> packetReader) {
        this.id = id;
    ...
    static {
        REGISTRY = new ClientboundPackets1_4_2[256];
        ClientboundPackets1_4_2[] clientboundPackets1_4_2Array = ClientboundPackets1_4_2.values();
        int n = clientboundPackets1_4_2Array.length;
        for (int i = 0; i < n; ++i) {
            ClientboundPackets1_4_2 packet;
            ClientboundPackets1_4_2.REGISTRY[packet.id] = packet = clientboundPackets1_4_2Array[i];
        }
    }
}
