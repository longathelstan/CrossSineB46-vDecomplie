...
public enum EntityDataIndex1_7_6 {
    ...
    private static final HashMap<Pair<EntityTypes1_8.EntityType, Integer>, EntityDataIndex1_7_6> ENTITY_DATA_REWRITES;
    ...
    private static Optional<EntityDataIndex1_7_6> getIndex(EntityTypes1_8.EntityType type, int index2) {
    ...
    public static EntityDataIndex1_7_6 searchIndex(EntityTypes1_8.EntityType type, int index2) {
        EntityTypes1_8.EntityType currentType = type;
        do {
            Optional<EntityDataIndex1_7_6> optMeta;
            if (!(optMeta = EntityDataIndex1_7_6.getIndex(currentType, index2)).isPresent()) continue;
            return optMeta.get();
    ...
    static {
        ...
        for (EntityDataIndex1_7_6 index2 : EntityDataIndex1_7_6.values()) {
