...
public class TextRewriter {
    private static final Object2ObjectMap<String, String> TRANSLATIONS = new Object2ObjectOpenHashMap<String, String>(59, 0.99f);
    ...
    public String toClient(UserConnection user, String text) {
        ...
        TextUtils.iterateAll(component, c -> {
            TextHoverEvent textHoverEvent;
            AHoverEvent patt22414$temp = c.getStyle().getHoverEvent();
            if (patt22414$temp instanceof TextHoverEvent && (textHoverEvent = (TextHoverEvent)patt22414$temp).getAction().equals((Object)HoverEventAction.SHOW_ITEM)) {
                try {
                    ...
                    if (!ID_TO_NAME.containsKey(item.identifier())) {
                        ...
                        throw new IllegalArgumentException("Invalid item ID: " + n);
                    }
                    ...
                    if (!Via.getConfig().isSuppressConversionWarnings()) {
                        String string = textHoverEvent.getText().asUnformattedString();
                        ViaLegacy.getPlatform().getLogger().log(Level.WARNING, "Error remapping NBT in show_item:" + string, e);
                    }
