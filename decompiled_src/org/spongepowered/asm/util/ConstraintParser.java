...
public final class ConstraintParser {
    ...
    public static class Constraint {
        ...
        private boolean has(int index2) {
            return this.constraint[index2] != null;
        }

        private String elem(int index2) {
            return this.constraint[index2];
        }

        private int val(int index2) {
            return this.constraint[index2] != null ? Integer.parseInt(this.constraint[index2]) : 0;
        }
