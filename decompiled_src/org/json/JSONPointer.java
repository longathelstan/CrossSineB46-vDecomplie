...
public class JSONPointer {
    ...
    private Object readByIndexToken(Object current, String indexToken) {
        try {
            int index2 = Integer.parseInt(indexToken);
            JSONArray currentArr = (JSONArray)current;
            if (index2 >= currentArr.length()) {
                throw new JSONPointerException(String.format("index %d is out of bounds - the array has %d elements", index2, currentArr.length()));
            }
            return currentArr.get(index2);
        }
