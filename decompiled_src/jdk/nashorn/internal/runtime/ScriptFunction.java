...
extends ScriptObject {
    ...
    public static ScriptFunction create(Object[] constants, int index2, ScriptObject scope) {
        RecompilableScriptFunctionData data = (RecompilableScriptFunctionData)constants[index2];
        return new ScriptFunction(data, ScriptFunction.getMap(data.isStrict()), scope, Global.instance());
    }

    public static ScriptFunction create(Object[] constants, int index2) {
        return ScriptFunction.create(constants, index2, null);
    }
