...
extends ArrayFilter {
    ...
    public ArrayData set(int index2, Object value, boolean strict) {
        this.deleted.clear(ArrayIndex.toLongIndex(index2));
    ...
    public boolean has(int index2) {
        return super.has(index2) && this.deleted.isClear(ArrayIndex.toLongIndex(index2));
    }
    ...
    public Object pop() {
        ...
        if (super.has((int)index2)) {
            boolean isDeleted = this.deleted.isSet(index2);
