...
public final class ArrayIndex {
    ...
    public static boolean isValidArrayIndex(int index2) {
        return index2 != -1;
    }

    public static long toLongIndex(int index2) {
        return JSType.toUint32(index2);
    }

    public static String toKey(int index2) {
        return Long.toString(JSType.toUint32(index2));
    }
}
