...
public abstract class ArrayData {
    ...
    protected static void throwUnwarranted(ArrayData data, int programPoint, int index2) {
        throw new UnwarrantedOptimismException(data.getObject(index2), programPoint);
    }
    ...
    public int getIntOptimistic(int index2, int programPoint) {
        throw new UnwarrantedOptimismException(this.getObject(index2), programPoint, this.getOptimisticType());
    }
    ...
    public PropertyDescriptor getDescriptor(Global global, int index2) {
        return global.newDataDescriptor(this.getObject(index2), true, true, true);
    }
    ...
    extends ContinuousArrayData {
        ...
        private ArrayData toRealArrayData(int index2) {
            IntArrayData newData = new IntArrayData(index2 + 1);
            return new DeletedRangeArrayFilter(newData, 0L, index2);
        }
        ...
        public ArrayData set(int index2, Object value, boolean strict) {
            return this.toRealArrayData(index2).set(index2, value, strict);
        }
