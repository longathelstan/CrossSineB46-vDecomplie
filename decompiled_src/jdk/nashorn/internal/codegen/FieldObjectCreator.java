...
extends ObjectCreator<T> {
    ...
    public void populateRange(MethodEmitter method, Type objectType, int objectSlot, int start, int end) {
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (!ArrayIndex.isValidArrayIndex(index2)) {
                ...
                this.putSlot(method, ArrayIndex.toLongIndex(index2), tuple);
            }
    ...
    private void putSlot(MethodEmitter method, long index2, MapTuple<T> tuple) {
        this.loadIndex(method, index2);
