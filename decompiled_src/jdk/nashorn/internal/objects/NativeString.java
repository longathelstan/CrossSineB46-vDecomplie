...
implements OptimisticBuiltins {
    ...
    private static Object get(Object self, Object key) {
        ...
        if (index2 >= 0 && index2 < cs.length()) {
            return String.valueOf(cs.charAt(index2));
        }
    ...
    public Object get(Object key) {
        ...
        if (index2 >= 0 && index2 < this.value.length()) {
            return String.valueOf(this.value.charAt(index2));
        }
    ...
    public boolean has(Object key) {
        Object primitiveKey = JSType.toPrimitive(key, String.class);
        int index2 = ArrayIndex.getArrayIndex(primitiveKey);
        return this.isValidStringIndex(index2) || super.has(primitiveKey);
    }
    ...
    public boolean has(double key) {
        ...
        return this.isValidStringIndex(index2) || super.has(key);
    }
    ...
    public boolean hasOwnProperty(Object key) {
        Object primitiveKey = JSType.toPrimitive(key, String.class);
        int index2 = ArrayIndex.getArrayIndex(primitiveKey);
        return this.isValidStringIndex(index2) || super.hasOwnProperty(primitiveKey);
    }
    ...
    public boolean hasOwnProperty(double key) {
        int index2 = ArrayIndex.getArrayIndex(key);
        return this.isValidStringIndex(index2) || super.hasOwnProperty(key);
    }
    ...
    public boolean delete(double key, boolean strict) {
        int index2 = ArrayIndex.getArrayIndex(key);
        return this.checkDeleteIndex(index2, strict) ? false : super.delete(key, strict);
    }
    ...
    public boolean delete(Object key, boolean strict) {
        Object primitiveKey = JSType.toPrimitive(key, String.class);
        int index2 = ArrayIndex.getArrayIndex(primitiveKey);
        return this.checkDeleteIndex(index2, strict) ? false : super.delete(primitiveKey, strict);
    }

    private boolean checkDeleteIndex(int index2, boolean strict) {
        if (this.isValidStringIndex(index2)) {
            if (strict) {
                throw ECMAErrors.typeError("cant.delete.property", Integer.toString(index2), ScriptRuntime.safeToString(this));
            }
            return true;
        }
        return false;
    ...
    public Object getOwnPropertyDescriptor(String key) {
        ...
        if (index2 >= 0 && index2 < this.value.length()) {
            ...
            return global.newDataDescriptor(String.valueOf(this.value.charAt(index2)), false, true, false);
        }
    ...
    public static String fromCharCode(Object self, Object ... args2) {
        ...
        for (Object arg : args2) {
            buf[index2++] = (char)JSType.toUint16(arg);
        }
