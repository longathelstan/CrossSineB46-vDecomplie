...
public class JSONParser {
        ...
        block5: while (this.pos < this.length) {
            ...
            switch (c) {
                case 34: {
                    ...
                    this.expectColon();
                    Object value = this.parseLiteral();
                    int index2 = ArrayIndex.getArrayIndex(id);
                    if (ArrayIndex.isValidArrayIndex(index2)) {
                        arrayData = JSONParser.addArrayElement(arrayData, index2, value);
                    } else {
    ...
    private static ArrayData addArrayElement(ArrayData arrayData, int index2, Object value) {
        ...
        return newArrayData.set(index2, value, false);
    }
    ...
    private Object parseArray() {
        ...
        block4: while (this.pos < this.length) {
            ...
            long index2 = arrayData.length();
            arrayData = arrayData.ensure(index2).set((int)index2, this.parseLiteral(), true);
            state = 1;
        }
        throw this.expectedError(this.pos, ", or ]", "eof");
    }
