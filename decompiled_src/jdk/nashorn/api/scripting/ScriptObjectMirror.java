...
implements Bindings {
    ...
    @Override
    public Object getSlot(final int index2) {
        return this.inGlobal(new Callable<Object>(){

            @Override
            public Object call() {
                return ScriptObjectMirror.this.wrapLikeMe(ScriptObjectMirror.this.sobj.get(index2));
            }
        });
    }
    ...
    @Override
    public void setSlot(final int index2, final Object value) {
        this.inGlobal(new Callable<Void>(){

            @Override
            public Void call() {
                ScriptObjectMirror.this.sobj.set(index2, ScriptObjectMirror.unwrap(value, ScriptObjectMirror.this.global), ScriptObjectMirror.this.getCallSiteFlags());
                return null;
            }
        });
    }
    ...
    private static Object[] wrapArray(Object[] args2, Object homeGlobal, boolean jsonCompatible) {
        ...
        for (Object obj : args2) {
            newArgs[index2] = ScriptObjectMirror.wrap(obj, homeGlobal, jsonCompatible);
            ++index2;
        }
        return newArgs;
    }
    ...
    public static Object[] unwrapArray(Object[] args2, Object homeGlobal) {
        ...
        int index2 = 0;
        for (Object obj : args2) {
            newArgs[index2] = ScriptObjectMirror.unwrap(obj, homeGlobal);
            ++index2;
        }
        return newArgs;
    }
