...
public final class GsonExtensionKt {
    ...
    @Nullable
    public static final String string(@NotNull JsonArray $this$string, int index2) {
        Intrinsics.checkNotNullParameter($this$string, "<this>");
        return $this$string.size() > index2 ? $this$string.get(index2).getAsString() : (String)null;
    }

    @Nullable
    public static final Integer int(@NotNull JsonArray $this$int, int index2) {
        Intrinsics.checkNotNullParameter($this$int, "<this>");
        return $this$int.size() > index2 ? Integer.valueOf($this$int.get(index2).getAsInt()) : (Integer)null;
    }

    @Nullable
    public static final Long long(@NotNull JsonArray $this$long, int index2) {
        Intrinsics.checkNotNullParameter($this$long, "<this>");
        return $this$long.size() > index2 ? Long.valueOf($this$long.get(index2).getAsLong()) : (Long)null;
    }

    @Nullable
    public static final Double double(@NotNull JsonArray $this$double, int index2) {
        Intrinsics.checkNotNullParameter($this$double, "<this>");
        return $this$double.size() > index2 ? Double.valueOf($this$double.get(index2).getAsDouble()) : (Double)null;
    }

    @Nullable
    public static final Boolean boolean(@NotNull JsonArray $this$boolean, int index2) {
        Intrinsics.checkNotNullParameter($this$boolean, "<this>");
        return $this$boolean.size() > index2 ? Boolean.valueOf($this$boolean.get(index2).getAsBoolean()) : (Boolean)null;
    }

    @Nullable
    public static final JsonObject obj(@NotNull JsonArray $this$obj, int index2) {
        Intrinsics.checkNotNullParameter($this$obj, "<this>");
        return $this$obj.size() > index2 ? $this$obj.get(index2).getAsJsonObject() : (JsonObject)null;
    }

    @Nullable
    public static final JsonArray array(@NotNull JsonArray $this$array, int index2) {
        Intrinsics.checkNotNullParameter($this$array, "<this>");
        return $this$array.size() > index2 ? $this$array.get(index2).getAsJsonArray() : (JsonArray)null;
    }
}
