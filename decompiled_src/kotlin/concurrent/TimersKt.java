...
public final class TimersKt {
    @InlineOnly
    private static final TimerTask schedule(Timer $this$schedule, long delay2, Function1<? super TimerTask, Unit> action) {
        ...
        $this$schedule.schedule(task, delay2);
        return task;
    }
    ...
    @InlineOnly
    private static final TimerTask schedule(Timer $this$schedule, long delay2, long period, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter($this$schedule, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        TimerTask task = new /* invalid duplicate definition of identical inner class */;
        $this$schedule.schedule(task, delay2, period);
        return task;
    }
    ...
    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(Timer $this$scheduleAtFixedRate, long delay2, long period, Function1<? super TimerTask, Unit> action) {
        Intrinsics.checkNotNullParameter($this$scheduleAtFixedRate, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        TimerTask task = new /* invalid duplicate definition of identical inner class */;
        $this$scheduleAtFixedRate.scheduleAtFixedRate(task, delay2, period);
        return task;
    }
