...
class LazyKt__LazyJVMKt {
    ...
    @NotNull
    public static final <T> Lazy<T> lazy(@NotNull LazyThreadSafetyMode mode2, @NotNull Function0<? extends T> initializer) {
        Lazy lazy;
        Intrinsics.checkNotNullParameter((Object)mode2, "mode");
        Intrinsics.checkNotNullParameter(initializer, "initializer");
        LazyThreadSafetyMode lazyThreadSafetyMode = mode2;
