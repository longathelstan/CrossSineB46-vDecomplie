    ...
    private static final long parseDuration(String value, boolean strictIso) {
        ...
        if (value.charAt(index2) == 'P') {
            ...
            while (index2 < length) {
                ...
                String $i$f$skipWhile22 = string.substring(index2, $this$skipWhile$iv$iv22);
                ...
                if ((index2 += component.length()) < 0 || index2 > StringsKt.getLastIndex($i$f$substringWhile322)) {
                    int it = index2;
                    boolean bl = false;
                    throw new IllegalArgumentException(Intrinsics.stringPlus("Missing unit for value ", component));
                }
                char unitChar = $i$f$substringWhile322.charAt(index2);
                int $i$f$substringWhile322 = index2;
                index2 = $i$f$substringWhile322 + 1;
            ...
            if (StringsKt.regionMatches(value, index2, infinityString, 0, Math.max(length - index2, infinityString.length()), true)) {
                ...
                if (hasSign && value.charAt(index2) == '(' && StringsKt.last(value) == ')') {
                    allowSpaces = true;
                    if (++index2 == --length) {
                        throw new IllegalArgumentException("No components");
                    }
                ...
                while (index2 < length) {
                    ...
                    String $i$f$skipWhile32 = it.substring(index2, $this$skipWhile$iv$iv422);
                    ...
                    int n = i$iv$iv3;
                    String string = $this$skipWhile$iv$iv422.substring(index2, n);
