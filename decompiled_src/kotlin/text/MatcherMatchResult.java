...
implements MatchResult {
    ...
    public MatcherMatchResult(@NotNull Matcher matcher, @NotNull CharSequence input) {
        ...
        this.groups = new MatchNamedGroupCollection(this){
            ...
            @Nullable
            public MatchGroup get(int index2) {
                MatchGroup matchGroup;
                IntRange range = RegexKt.access$range(MatcherMatchResult.access$getMatchResult(this.this$0), index2);
                if (range.getStart() >= 0) {
                    String string = MatcherMatchResult.access$getMatchResult(this.this$0).group(index2);
