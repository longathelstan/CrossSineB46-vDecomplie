...
extends StringsKt__RegexExtensionsKt {
    ...
    @InlineOnly
    private static final void set(StringBuilder $this$set, int index2, char value) {
        Intrinsics.checkNotNullParameter($this$set, "<this>");
        $this$set.setCharAt(index2, value);
    }
    ...
    @WasExperimental(markerClass={ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder deleteAt(StringBuilder $this$deleteAt, int index2) {
        Intrinsics.checkNotNullParameter($this$deleteAt, "<this>");
        StringBuilder stringBuilder = $this$deleteAt.deleteCharAt(index2);
    ...
    @WasExperimental(markerClass={ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder insertRange(StringBuilder $this$insertRange, int index2, char[] value, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter($this$insertRange, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        StringBuilder stringBuilder = $this$insertRange.insert(index2, value, startIndex, endIndex - startIndex);
    ...
    @WasExperimental(markerClass={ExperimentalStdlibApi.class})
    @InlineOnly
    private static final StringBuilder insertRange(StringBuilder $this$insertRange, int index2, CharSequence value, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter($this$insertRange, "<this>");
        Intrinsics.checkNotNullParameter(value, "value");
        StringBuilder stringBuilder = $this$insertRange.insert(index2, value, startIndex, endIndex);
