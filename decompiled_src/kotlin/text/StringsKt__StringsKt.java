...
extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence trim(@NotNull CharSequence $this$trim, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (startIndex <= endIndex) {
            int index2 = !startFound ? startIndex : endIndex;
            boolean match = predicate.invoke(Character.valueOf($this$trim.charAt(index2)));
            if (!startFound) {
                if (!match) {
                    startFound = true;
                    continue;
    ...
    public static final CharSequence trimStart(@NotNull CharSequence $this$trimStart, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (n < n2) {
            int index2;
            if (predicate.invoke(Character.valueOf($this$trimStart.charAt(index2 = n++))).booleanValue()) continue;
            return $this$trimStart.subSequence(index2, $this$trimStart.length());
        }
        return "";
    }
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence $this$trimEnd, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        if (0 <= n) {
            do {
                int index2;
                if (predicate.invoke(Character.valueOf($this$trimEnd.charAt(index2 = n--))).booleanValue()) continue;
                return $this$trimEnd.subSequence(0, index2 + 1);
            } while (0 <= n);
        }
        return "";
    }
    ...
    public static final boolean hasSurrogatePairAt(@NotNull CharSequence $this$hasSurrogatePairAt, int index2) {
        Intrinsics.checkNotNullParameter($this$hasSurrogatePairAt, "<this>");
        return (0 <= index2 ? index2 <= $this$hasSurrogatePairAt.length() - 2 : false) && Character.isHighSurrogate($this$hasSurrogatePairAt.charAt(index2)) && Character.isLowSurrogate($this$hasSurrogatePairAt.charAt(index2 + 1));
    }
    ...
    public static final String substringBefore(@NotNull String $this$substringBefore, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        int index2 = StringsKt.indexOf$default((CharSequence)$this$substringBefore, delimiter, 0, false, 6, null);
        if (index2 == -1) {
    ...
    public static final String substringAfter(@NotNull String $this$substringAfter, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.indexOf$default((CharSequence)$this$substringAfter, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final String substringBeforeLast(@NotNull String $this$substringBeforeLast, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.lastIndexOf$default((CharSequence)$this$substringBeforeLast, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final String substringAfterLast(@NotNull String $this$substringAfterLast, char delimiter, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.lastIndexOf$default((CharSequence)$this$substringAfterLast, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final String replaceBefore(@NotNull String $this$replaceBefore, char delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.indexOf$default((CharSequence)$this$replaceBefore, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
            String string2 = $this$replaceBefore;
            int n = 0;
            string = ((Object)StringsKt.replaceRange((CharSequence)string2, n, index2, (CharSequence)replacement)).toString();
        }
        return string;
    }
    ...
    public static final String replaceAfter(@NotNull String $this$replaceAfter, char delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.indexOf$default((CharSequence)$this$replaceAfter, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final String replaceAfterLast(@NotNull String $this$replaceAfterLast, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.lastIndexOf$default((CharSequence)$this$replaceAfterLast, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final String replaceBeforeLast(@NotNull String $this$replaceBeforeLast, char delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkNotNullParameter(replacement, "replacement");
        Intrinsics.checkNotNullParameter(missingDelimiterValue, "missingDelimiterValue");
        int index2 = StringsKt.lastIndexOf$default((CharSequence)$this$replaceBeforeLast, delimiter, 0, false, 6, null);
        if (index2 == -1) {
            string = missingDelimiterValue;
        } else {
    ...
    public static final boolean regionMatchesImpl(@NotNull CharSequence $this$regionMatchesImpl, int thisOffset, @NotNull CharSequence other, int otherOffset, int length, boolean ignoreCase) {
        ...
        while (n < length) {
            int index2;
            if (CharsKt.equals($this$regionMatchesImpl.charAt(thisOffset + (index2 = n++)), other.charAt(otherOffset + index2), ignoreCase)) continue;
            return false;
        }
        return true;
    }
    ...
    public static final int indexOfAny(@NotNull CharSequence $this$indexOfAny, @NotNull char[] chars, int startIndex, boolean ignoreCase) {
        ...
        if (n2 <= (n = StringsKt.getLastIndex($this$indexOfAny))) {
            ...
            do {
                ...
                block4: {
                    index2 = n2++;
                    char charAtIndex = $this$indexOfAny.charAt(index2);
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence $this$lastIndexOfAny, @NotNull char[] chars, int startIndex, boolean ignoreCase) {
        ...
        if (0 <= n) {
            do {
                ...
                block4: {
                    index2 = n--;
                    char charAtIndex = $this$lastIndexOfAny.charAt(index2);
                    char[] $this$any$iv = chars;
                    boolean $i$f$any = false;
                    for (char element$iv : $this$any$iv) {
                        char it = element$iv;
        ...
        if ($this$indexOf instanceof String && other instanceof String) {
            ...
            if (n3 > 0 && n <= n2 || n3 < 0 && n2 <= n) {
                ...
                do {
                    index2 = n;
                    n += n3;
                    if (!StringsKt.regionMatches((String)other, 0, (String)$this$indexOf, index2, other.length(), ignoreCase)) continue;
                    return index2;
                } while (index2 != n2);
            }
        } else {
            ...
            if (n5 > 0 && n <= n4 || n5 < 0 && n4 <= n) {
                ...
                do {
                    index3 = n;
                    n += n5;
                    if (!StringsKt.regionMatchesImpl(other, 0, $this$indexOf, index3, other.length(), ignoreCase)) continue;
                    return index3;
                } while (index3 != n4);
            }
        }
                ...
                do {
                    ...
                    block9: {
                        ...
                        for (Object element$iv : $this$firstOrNull$iv) {
                            ...
                            boolean bl = false;
                            if (!StringsKt.regionMatches(it, 0, (String)$this$findAnyOf, index3, it.length(), ignoreCase)) continue;
                            v1 = element$iv;
                            break block9;
                        }
                        v1 = null;
                    ...
                    return TuplesKt.to(index3, matchingString);
                } while (index3 != n2);
            }
        } else {
            int n = indices.getFirst();
                ...
                do {
                    ...
                    block10: {
                        ...
                        for (Object element$iv : $this$firstOrNull$iv) {
                            String it = (String)element$iv;
                            boolean bl = false;
                            if (!StringsKt.regionMatchesImpl(it, 0, $this$findAnyOf, index4, it.length(), ignoreCase)) continue;
                            v2 = element$iv;
                            break block10;
                        }
                        v2 = null;
                    ...
                    if (matchingString == null) continue;
                    return TuplesKt.to(index4, matchingString);
                } while (index4 != n4);
            }
        }
        return null;
