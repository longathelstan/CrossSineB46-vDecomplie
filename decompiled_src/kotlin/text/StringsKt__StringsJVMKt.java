...
extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replaceFirst(@NotNull String $this$replaceFirst, char oldChar, char newChar, boolean ignoreCase) {
        ...
        int index2 = StringsKt.indexOf$default((CharSequence)$this$replaceFirst, oldChar, 0, ignoreCase, 2, null);
        if (index2 < 0) {
            ...
            string = ((Object)StringsKt.replaceRange((CharSequence)string2, index2, n, charSequence)).toString();
        }
        return string;
    }
    ...
    public static final String replaceFirst(@NotNull String $this$replaceFirst, @NotNull String oldValue, @NotNull String newValue, boolean ignoreCase) {
        ...
        Intrinsics.checkNotNullParameter(oldValue, "oldValue");
        Intrinsics.checkNotNullParameter(newValue, "newValue");
        int index2 = StringsKt.indexOf$default((CharSequence)$this$replaceFirst, oldValue, 0, ignoreCase, 2, null);
        if (index2 < 0) {
            string = $this$replaceFirst;
        } else {
            String string2 = $this$replaceFirst;
            int n = index2 + oldValue.length();
            string = ((Object)StringsKt.replaceRange((CharSequence)string2, index2, n, (CharSequence)newValue)).toString();
        }
        return string;
    }
    ...
    @InlineOnly
    private static final int codePointAt(String $this$codePointAt, int index2) {
        Intrinsics.checkNotNullParameter($this$codePointAt, "<this>");
        return $this$codePointAt.codePointAt(index2);
    }

    @InlineOnly
    private static final int codePointBefore(String $this$codePointBefore, int index2) {
        Intrinsics.checkNotNullParameter($this$codePointBefore, "<this>");
        return $this$codePointBefore.codePointBefore(index2);
    }
    ...
    @InlineOnly
    private static final int offsetByCodePoints(String $this$offsetByCodePoints, int index2, int codePointOffset) {
        Intrinsics.checkNotNullParameter($this$offsetByCodePoints, "<this>");
        return $this$offsetByCodePoints.offsetByCodePoints(index2, codePointOffset);
    }
