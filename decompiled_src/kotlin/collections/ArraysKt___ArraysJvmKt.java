...
extends ArraysKt__ArraysKt {
    @InlineOnly
    private static final <T> T elementAt(T[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final byte elementAt(byte[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final short elementAt(short[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final int elementAt(int[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final long elementAt(long[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final float elementAt(float[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final double elementAt(double[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final boolean elementAt(boolean[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }

    @InlineOnly
    private static final char elementAt(char[] $this$elementAt, int index2) {
        Intrinsics.checkNotNullParameter($this$elementAt, "<this>");
        return $this$elementAt[index2];
    }
    ...
    public static final List<Byte> asList(@NotNull byte[] $this$asList) {
        ...
        return (List)((Object)new RandomAccess($this$asList){
            ...
            public Byte get(int index2) {
                return this.$this_asList[index2];
            }
    ...
    public static final List<Float> asList(@NotNull float[] $this$asList) {
        ...
        return (List)((Object)new RandomAccess($this$asList){
            ...
            public Float get(int index2) {
                return Float.valueOf(this.$this_asList[index2]);
            }
    ...
    public static final List<Character> asList(@NotNull char[] $this$asList) {
        ...
        return (List)((Object)new RandomAccess($this$asList){
            ...
            public Character get(int index2) {
                return Character.valueOf(this.$this_asList[index2]);
            }
    ...
    public static final <T> T[] plus(@NotNull T[] $this$plus, T element) {
        ...
        int index2 = $this$plus.length;
        T[] result = Arrays.copyOf($this$plus, index2 + 1);
    ...
    public static final byte[] plus(@NotNull byte[] $this$plus, byte element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        byte[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final short[] plus(@NotNull short[] $this$plus, short element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        short[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final int[] plus(@NotNull int[] $this$plus, int element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        int[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final long[] plus(@NotNull long[] $this$plus, long element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        long[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final float[] plus(@NotNull float[] $this$plus, float element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        float[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final double[] plus(@NotNull double[] $this$plus, double element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        double[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final boolean[] plus(@NotNull boolean[] $this$plus, boolean element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        boolean[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final char[] plus(@NotNull char[] $this$plus, char element) {
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
        int index2 = $this$plus.length;
        char[] result = Arrays.copyOf($this$plus, index2 + 1);
        result[index2] = element;
        Intrinsics.checkNotNullExpressionValue(result, "result");
        return result;
    }
    ...
    public static final <T> T[] plus(@NotNull T[] $this$plus, @NotNull Collection<? extends T> elements) {
        ...
        int index2 = $this$plus.length;
        T[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final byte[] plus(@NotNull byte[] $this$plus, @NotNull Collection<Byte> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        byte[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final short[] plus(@NotNull short[] $this$plus, @NotNull Collection<Short> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        short[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final int[] plus(@NotNull int[] $this$plus, @NotNull Collection<Integer> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        int[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final long[] plus(@NotNull long[] $this$plus, @NotNull Collection<Long> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        long[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final float[] plus(@NotNull float[] $this$plus, @NotNull Collection<Float> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        float[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final double[] plus(@NotNull double[] $this$plus, @NotNull Collection<Double> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        double[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final boolean[] plus(@NotNull boolean[] $this$plus, @NotNull Collection<Boolean> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        boolean[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final char[] plus(@NotNull char[] $this$plus, @NotNull Collection<Character> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        int index2 = $this$plus.length;
        char[] result = Arrays.copyOf($this$plus, index2 + elements.size());
    ...
    public static final Byte[] toTypedArray(@NotNull byte[] $this$toTypedArray) {
        ...
        while (n < n2) {
            int index2 = n++;
            result[index2] = $this$toTypedArray[index2];
        }
        return result;
    }
    ...
    public static final Float[] toTypedArray(@NotNull float[] $this$toTypedArray) {
        ...
        while (n < n2) {
            int index2 = n++;
            result[index2] = Float.valueOf($this$toTypedArray[index2]);
        }
        return result;
    }
    ...
    public static final Character[] toTypedArray(@NotNull char[] $this$toTypedArray) {
        ...
        while (n < n2) {
            int index2 = n++;
            result[index2] = Character.valueOf($this$toTypedArray[index2]);
        }
        return result;
    }
