...
public final class UArraySortingKt {
    ...
    private static final void quickSort-4UcCI2c(byte[] array, int left, int right) {
        int index2 = UArraySortingKt.partition-4UcCI2c(array, left, right);
        if (left < index2 - 1) {
            UArraySortingKt.quickSort-4UcCI2c(array, left, index2 - 1);
        }
        if (index2 < right) {
            UArraySortingKt.quickSort-4UcCI2c(array, index2, right);
        }
    }
    ...
    private static final void quickSort-Aa5vz7o(short[] array, int left, int right) {
        int index2 = UArraySortingKt.partition-Aa5vz7o(array, left, right);
        if (left < index2 - 1) {
            UArraySortingKt.quickSort-Aa5vz7o(array, left, index2 - 1);
        }
        if (index2 < right) {
            UArraySortingKt.quickSort-Aa5vz7o(array, index2, right);
        }
    }
    ...
    private static final void quickSort-oBK06Vg(int[] array, int left, int right) {
        int index2 = UArraySortingKt.partition-oBK06Vg(array, left, right);
        if (left < index2 - 1) {
            UArraySortingKt.quickSort-oBK06Vg(array, left, index2 - 1);
        }
        if (index2 < right) {
            UArraySortingKt.quickSort-oBK06Vg(array, index2, right);
        }
    }
    ...
    private static final void quickSort--nroSd4(long[] array, int left, int right) {
        int index2 = UArraySortingKt.partition--nroSd4(array, left, right);
        if (left < index2 - 1) {
            UArraySortingKt.quickSort--nroSd4(array, left, index2 - 1);
        }
        if (index2 < right) {
            UArraySortingKt.quickSort--nroSd4(array, index2, right);
        }
    }
