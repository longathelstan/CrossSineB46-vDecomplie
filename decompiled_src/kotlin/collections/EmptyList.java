...
KMappedMarker {
    ...
    @NotNull
    public Void get(int index2) {
        throw new IndexOutOfBoundsException("Empty list doesn't contain element at index " + index2 + '.');
    }
    ...
    public ListIterator listIterator(int index2) {
        if (index2 != 0) {
            throw new IndexOutOfBoundsException(Intrinsics.stringPlus("Index: ", index2));
        }
        return EmptyIterator.INSTANCE;
    }
    ...
    public void add(int index2, Void element) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }

    public boolean addAll(int index2, Collection elements) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public Void set(int index2, Void element) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
