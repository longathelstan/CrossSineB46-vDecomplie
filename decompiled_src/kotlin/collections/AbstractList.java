...
KMappedMarker {
    ...
    public ListIterator<E> listIterator(int index2) {
        return new ListIteratorImpl(index2);
    }
    ...
    implements RandomAccess {
        ...
        public E get(int index2) {
            Companion.checkElementIndex$kotlin_stdlib(index2, this._size);
            return this.list.get(this.fromIndex + index2);
        }
    ...
    KMappedMarker {
        public ListIteratorImpl(int index2) {
            Intrinsics.checkNotNullParameter(AbstractList.this, "this$0");
            Companion.checkPositionIndex$kotlin_stdlib(index2, AbstractList.this.size());
    ...
    public static final class Companion {
        ...
        public final void checkElementIndex$kotlin_stdlib(int index2, int size) {
            if (index2 < 0 || index2 >= size) {
                throw new IndexOutOfBoundsException("index: " + index2 + ", size: " + size);
            }
        }

        public final void checkPositionIndex$kotlin_stdlib(int index2, int size) {
            if (index2 < 0 || index2 > size) {
                throw new IndexOutOfBoundsException("index: " + index2 + ", size: " + size);
            }
        }
